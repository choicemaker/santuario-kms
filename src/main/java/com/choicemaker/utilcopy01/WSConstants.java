...
/**
 * Copied from wss4j-ws-security-dom-2.1.5-sources.jar, and then pruned, to
...
public final class WSConstants extends WSS4JConstants {
	 ...
	 * specification
	 */
	public static final QName BINARY_TOKEN = new QName(WSConstants.WSSE_NS,
			WSConstants.BINARY_TOKEN_LN);
	/**
	 * <code>wsse:UsernameToken</code> as defined by WS Security specification
	 */
	public static final QName USERNAME_TOKEN = new QName(WSConstants.WSSE_NS,
	...
	/**
	 * <code>wsse11:signatureConfirmation</code> as defined by OASIS WS Security
	 * specification,
	 */
	public static final QName SIGNATURE_CONFIRMATION = new QName(
			WSConstants.WSSE11_NS, WSConstants.SIGNATURE_CONFIRMATION_LN);
	/**
	 ...
	 * specification, enhanced by WS Security specification
	 */
	 ...
	 */
	public static final QName SAML2_TOKEN = new QName(WSConstants.SAML2_NS,
			WSConstants.ASSERTION_LN);

	/**
	 * <code>saml:EncryptedAssertion</code> as defined by SAML v2.0
	 * specification
	 */
	public static final QName ENCRYPTED_ASSERTION = new QName(
			WSConstants.SAML2_NS, WSConstants.ENCRYPED_ASSERTION_LN);
	...
	/**
	 * Sets the
	 * {@link org.apache.wss4j.dom.message.WSSecSignature#build(Document, Crypto, WSSecHeader)
     * }
     ...
     * }
	 * or the
	 * {@link org.apache.wss4j.dom.message.WSSecEncrypt#build(Document, Crypto, WSSecHeader)
     * }
	 ...
	 * certificate to encrypt the symmetric key used to encrypt data. The
	 * certificate is converted into a <code>KeyIdentifier</code> token and sent
	 * to the receiver. Thus the complete certificate data is transfered to
	 * receiver. The X509 profile recommends to use {@link #ISSUER_SERIAL}
	 ...
	 * {@link org.apache.wss4j.dom.message.WSSecSignature#build(Document, Crypto, WSSecHeader)
     * }
	 * method to send a <code>SubjectKeyIdentifier</code> to identify the
	 * signing certificate.
	 * <p/>
	 ...
	 * identifier ThumbprintSHA1.
	 *
	 * This identifier uses the SHA-1 digest of a security token to identify the
	 * security token. Please refer to chapter 7.2 of the OASIS WSS 1.1
	 * specification.
	 *
	 */
	 ...
	 * key identifier EncryptedKeySHA1.
	 *
	 * This identifier uses the SHA-1 digest of a security token to identify the
	 * security token. Please refer to chapter 7.3 of the OASIS WSS 1.1
	 * specification.
	 */
	...
	/**
	 * <code>ENDPOINT_KEY_IDENTIFIER</code> is used to specify service endpoint
	 * as public key identifier.
	 *
	 * Constant is useful in case of symmetric holder of key, where token
	 * service can determine target service public key to encrypt shared secret.
	 */
	public static final int ENDPOINT_KEY_IDENTIFIER = 14;

	/*
	 * The following values are bits that can be combined to for a set. Be
	 * careful when selecting new values.
	 */
	...
	public static final int UT_SIGN = 0x40; // perform signature with UT secret
											// key
